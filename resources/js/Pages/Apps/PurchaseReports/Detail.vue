<template>
    <Head>
        <title>Detail Purchase Report - Point Of Sale</title>
    </Head>
                                ...
                                <div class="card-body" style="text-align: right;">
                                    <table class="transaction-table" style="text-align: right;" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td>SUPPLIER</td>
                                            <td>:</td>
                                            <td>{{ transaction.supplier ? transaction.supplier.name_company : 'Umum' }}</td>
                                        </tr>
                                    </table>
                                ...
                                <div class="title" style="padding-bottom: 13px">
                                    ...
                                    <div class="transaction" style="text-align: center; width: 100%;">
                                        <table class="transaction-table" style="text-align: center; width: 100%;" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr v-for="(item, index) in transaction.purchase_transaction_details" :key="index">

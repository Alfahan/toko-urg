<template>
    <Head>
        <title>Add New Supplier - Point Of Sale</title>
    </Head>
    <main class="c-main">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-user-circle"></i> ADD NEW SUPPLIER</span>
                            </div>
                            <div class="card-body">
                                ...
                                <form @submit.prevent="submit">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="fw-bold">Name Company</label>
                                                <input class="form-control" v-model="form.name_company" :class="{ 'is-invalid': errors.name_company }" type="text" placeholder="Name Company">
                                            </div>

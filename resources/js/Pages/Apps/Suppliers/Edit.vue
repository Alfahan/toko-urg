<template>
    <Head>
        <title>Edit Supplier - Point Of Sale</title>
    </Head>
    <main class="c-main">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-user-circle"></i> EDIT SUPPLIER</span>
                            </div>
                            <div class="card-body">
                                ...
                                <form @submit.prevent="submit">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="fw-bold">Name Supplier</label>
                                                <input class="form-control" v-model="form.name_company" :class="{ 'is-invalid': errors.name_company }" type="text" placeholder="Name Supplier">
                                            </div>
                                            <div v-if="errors.name_company" class="alert alert-danger">
                                                {{ errors.name_company }}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            const form = reactive({
                name_company: props.supplier.name_company,
                no_telp: props.supplier.no_telp,
            ...
            const submit = () => {
                ...
                //send data to server
                Inertia.post(`/apps/suppliers/${props.supplier.id}`, {
                    //data

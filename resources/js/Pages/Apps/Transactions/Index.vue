...
<div class="table-responsive">
                                ...
                                <div class="text-end mt-4">
                                    ...
                                    <button v-if="hasAnyPermission(['transactions.order'])" @click.prevent="storeTransaction" class="btn btn-purple btn-md border-0 shadow text-uppercase m-2" :disabled="cash < grandTotal || grandTotal <= 0 ">Pay Order & Print</button>
                                    <button v-if="hasAnyPermission(['transactions.retur'])" @click.prevent="storeTransaction" class="btn btn-danger btn-md border-0 shadow text-uppercase" :disabled="cash > grandTotal || grandTotal >= 0 ">Pay Retur & Print</button>
                                </div>
                            </div>
                        </div>

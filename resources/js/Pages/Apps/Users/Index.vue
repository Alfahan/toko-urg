                            ...
                            <div class="card-body">
                                <form @submit.prevent="handleSearch">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" v-model="search" class="form-control" placeholder="search by user name...">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="width:20%" v-if="hasAnyPermission(['users.edit']) || hasAnyPermission(['users.delete'])">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="(user, index) in users.data" :key="index">
                                            ...
                                            <td class="text-center" v-if="hasAnyPermission(['users.edit']) || hasAnyPermission(['users.delete'])">
